...
routes.get('/change-password' , passport.checkUser,authController.changePasswordPage)
...
routes.get('/editProduct', passport.checkUser, adminController.editProductPage)
routes.post('/updateProduct', passport.checkUser, adminController.updateProduct)
routes.get('/deleteProduct', passport.checkUser, adminController.deleteProduct)
